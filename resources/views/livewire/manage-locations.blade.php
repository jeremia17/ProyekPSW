<div>
    <div>
        <div class="flex justify-between mx-7">
            ...
            <x-button wire:click="confirmLocationAdd"  class="px-5 py-2 text-white bg-yellow-500 rounded-md hover:bg--600">
                Create
            </x-button>
        </div>
        <div class="mt-4">
            ...
            <x-dialog-modal wire:model="confirmingLocationAdd">
                ...
                <x-slot name="content">
                    <div>
                        ...
                        <input type="text" wire:model="location.name" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm">
                        @error('location.name') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div>

                    <div>
                        <label for="address" class="block text-sm font-medium text-gray-700">Address</label>
                        <textarea type="text" wire:model="location.address" id="address" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm"></textarea>
                    ...
                    <div>
                        ...
                        <input type="tel" wire:model="location.telephone_number" minlength="10" maxlength="10" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="checkbox" wire:model="location.status" id="status"  class="block mt-1 p-2 border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm">
