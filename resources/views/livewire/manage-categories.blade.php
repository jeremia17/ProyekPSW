<div>
    <div>
        <div class="flex justify-between mx-7">
            ...
            <x-button wire:click="confirmCategoryAdd"  class="px-5 py-2 text-white bg-yellow-500 rounded-md hover:bg--600">
                Create
            </x-button>
        </div>
        <div class="mt-4">
            ...
            <x-dialog-modal wire:model="confirmingCategoryAdd">
                ...
                <x-slot name="content">
                    <div>
                        ...
                        <input type="text" wire:model="category.name" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm">
