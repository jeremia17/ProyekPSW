...
{{--            <x-button wire:click="confirmAppointmentAdd"  class="px-5 py-2 text-white bg-yellow-500 rounded-md hover:bg--600">--}}
{{--                Create--}}
{{--            </x-button>--}}
        </div>
        <div class="mt-4">
...
{{--                        <input type="text" wire:model="appointment.name" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm">--}}
