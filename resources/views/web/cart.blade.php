...
{{--                        </div>--}}
                        ...
                        <button @click="showCheckoutConfirmation = true" class="bg-yellow-500 text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg p-4 max-w-md mx-auto"  @click.outside="showCheckoutConfirmation = false" >
                ...
                <div class="mt-4 flex justify-end space-x-4">
                    ...
                    <form action="{{route('cart.checkout')}}" method="post">
                        @csrf
                        <button class="px-4 py-2 text-sm font-medium text-white bg-yellow-600 border border-transparent rounded-md hover:bg-yellow-700 focus:outline-none">
                            Confirm
                        </button>
                    </form>
