...
>
  <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
    ...
    <div class="mt-8 flex flex-wrap gap-4 text-center">
      <a
        href="{{route('services')}}"
        class="block w-full rounded bg-yellow-500 px-12 py-3 text-lg font-medium text-white shadow hover:bg-yellow-700 focus:outline-none focus:ring active:bg-yellow-500 sm:w-auto"
      >
Book Now      </a>
<a
          href="{{route('services')}}"
          class="block w-full rounded bg-white px-12 py-3 text-lg font-medium text-yellow-500 shadow hover:text-yellow-600 focus:outline-none focus:ring-offset-yellow-400 active:text-yellow-500 sm:w-auto"
        >
          Browse Services
        </a>
        ...
        {{-- <div class="absolute right-1 top-5 font-black text-yellow-600 text-7xl">30% OFF <br>THIS SEASON</div> --}}
 <div>
    <div class="text-center text-4xl font-semibold text-yellow-500 m-2 mt-5">Categories</div>
    ...
    <div class="container flex gap-10 p-10 pt-3 justify-center mx-auto">
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
          ...
          <span class="text-yellow-500 text-2xl">field</span>
      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/nails.jpg')}}"  alt="">
        <span class="text-yellow-500 text-2xl">ball</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/skin.jpg')}}" alt="">
        <span class="text-yellow-500 text-2xl">seat</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/makeup.jpg')}}" alt="">
        <span class="text-yellow-500 text-2xl">change room</span>
      </a>
    </div>
    ...
    <section class="pt-5 bg-white">
      <div class="md:w-4/5 mx-auto">
        <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
          <h3 class="mb-6 text-3xl text-yellow-500 font-bold">Popular Services</h3>
      ...
      <div class="flex justify-end mx-auto pb-5 gap-3 md:w-3/4">
        ...
        <a href="{{route('services')}}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
          View All Services
        </a>
      </div>
{{--
...
<div>
  <div class="text-center text-4xl font-semibold text-yellow-500 m-2">Offers</div>
</div>
<div class="flex gap-10 ">
        ...
        @foreach($deals as $deal)
            @if($deal->is_hidden == false)
                <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow ">
                    ...
                    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-yellow-500 rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 ">
                        View Offer
    ...
    <section class="pt-5 pb-5">
        <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
          <h3 class="text-3xl text-yellow-500 font-bold">Gallery</h3>
        </div>
    ...
    <section class="bg-white pt-5">
      <div class="md:w-3/4 mx-auto">
        <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
          <h3 class="mb-6 text-3xl text-yellow-500 font-bold">Field Service</h3>
          <p class="mb-6 pb-2 text-gray-700 md:mb-12 md:pb-0">
        ...
        <div class="grid gap-6 text-center p-6 md:grid-cols-3 lg:gap-12">
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="mb-4 text-xl font-semibold">Rey Gunadi</h5>
          ...
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="mb-4 text-xl font-semibold">Deny Sinurat</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
              Arsitek
            </h6>
            <p class="mb-4 text-neutral-500">
              ...
              "I had the best experince of my life at POLONIA BADMINTON! The tariner listened to exactly what I wanted and then gave me a training that exceeded my expectations. I felt so pampered and taken care of throughout the whole process. I can't wait to come back for my next appointment!
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
          ...
          <div class="mb-0">
            ...
            <h5 class="mb-4 text-xl font-semibold">Jappy Sirait</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
              Pemasaran Lapangan
            </h6>
            <p class="mb-4 text-neutral-500">
    ...
    <section class="mb-12" id="offer-banner">
      ...
      <div class="bg-yellow-600 alert alert-dismissible fade show fixed bottom-0 right-0 left-0 z-[1030] w-full py-4 px-6 text-white md:flex justify-between items-center text-center md:text-left">
    ...
    <!-- Footer container -->
<footer
class="bg-yellow-500 text-center text-neutral-100 lg:text-left">
<div
  ...
  <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    <div>
      <h6
        ...
        <img class="w-10 h-10" src="{{ asset('images/logooo.jpeg')}}" alt="">
        BADMINTON POLONIA
    </h6>
